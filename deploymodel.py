...
# Azure OpenAI Configuration (go ft Model)
endpoint = os.getenv("ENDPOINT_URL", "https://gongz-m82drk07-eastus2.openai.azure.com/")
deployment = os.getenv("DEPLOYMENT_NAME", "gpt-4o-2024-08-06-ft-8c54665af27247bcb97bb9cf1b6cadec-go-v1")
...
def save_response_as_go(repo_name, source_file, response):
    ...
    response_filename = f"{repo_name}_{source_file_name}_goft_test.go"
